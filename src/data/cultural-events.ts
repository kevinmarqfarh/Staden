...
const scannedCulturalEvents = [
  ...
  {
    id: "goteborg-art-sounds-festival-folkteatern-2026",
    title: "Göteborg Art Sounds Festival",
    category: "Festival",
    dateLabel: "24 sep",
    startDate: "2026-09-24",
    ...
    area: "Järntorget",
    description:
      "Experimentell musik med In Motion, Farida Amadou och Ji Youn Kang som en del av Göteborg Art Sounds Festival.",
    sourceLabel: "Folkteatern · Göteborg Art Sounds Festival",
    sourceUrl:
      "https://www.folkteatern.se/events/goteborg-art-sounds-festival-24-september-2026",
    isFree: true,
  },
