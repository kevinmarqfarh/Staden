...
const KOMPLETTERANDE_MUSEER: Objekt[] = [
  ...
  museum({ id: "obj-nevven-gallery", slug: "nevven-gallery", titel: "Nevven Gallery", underrubrik: "Internationellt samtida konstgalleri", varfor: "Konstnärsdrivet galleri med internationell samtidskonst inom måleri, skulptur och fotografi.", platsNamn: "Nevven Gallery", adress: "Molinsgatan 11, 411 33 Göteborg", url: "https://www.nevvengallery.com", kvarter: "centrum" }),
  museum({ id: "obj-galleri-20", slug: "galleri-20", titel: "Galleri 20", underrubrik: "Blandad samtidskonst i Kungssten", varfor: "Etablerat galleri med separatutställningar och grupputställningar inom akvarell, keramik, olja och collage.", platsNamn: "Galleri 20", adress: "Långedragsvägen 20, 426 71 Västra Frölunda", url: "https://www.goteborg.com/platser/galleri-20", kvarter: "majorna" }),
  museum({ id: "obj-v2-alleri", slug: "v2-alleri", titel: "V2 Alleri", underrubrik: "Konstgalleri i Vasastan", varfor: "Tillgängligt galleri där måleri, fotografi, keramik, smycken och skulptur möts i grupputställningar.", platsNamn: "V2 Alleri", adress: "Västergatan 2, 411 23 Göteborg", url: "https://www.goteborg.com/en/places/v2-alleri", kvarter: "centrum" }),
  museum({ id: "obj-galleri-box", slug: "galleri-box", titel: "Galleri Box", underrubrik: "Konstnärsdrivet galleri för samtidskonst", varfor: "Konstnärsdrivet galleri på Kastellgatan med svenska och internationella utställningar, samtal och föreläsningar.", platsNamn: "Galleri Box", adress: "Kastellgatan 10, 413 07 Göteborg", url: "https://www.goteborg.com/platser/galleri-box", kvarter: "majorna" }),
  museum({ id: "obj-galleri-54", slug: "galleri-54", titel: "Galleri 54", underrubrik: "Konstnärsdrivet samtidskonstgalleri", varfor: "Ett konstnärsdrivet galleri grundat 1959 som erbjuder konstnärer plats att utveckla idéer utan kommersiellt inflytande.", platsNamn: "Galleri 54", adress: "Kastellgatan 7, 413 07 Göteborg", url: "https://www.goteborg.com/platser/galleri-54", kvarter: "majorna" }),
  museum({ id: "obj-elvisannexet", slug: "elvisannexet", titel: "Elvisannexet", underrubrik: "Musikhistorisk utställning och mötesplats", varfor: "Utställning, butik och mötesplats i Älvängen med Elvisföremål, autografer och populärkulturella memorabilia.", platsNamn: "Elvisannexet", adress: "Göteborgsvägen 76, 446 35 Älvängen", url: "https://elvisannexet.se", kvarter: "nara_goteborg" }),
];
...
const KULTURHUS: Objekt[] = [
  ...
  museum({ id: "obj-kulturhus-vingen", slug: "kulturhuset-vingen", titel: "Kulturhuset Vingen", underrubrik: "Kulturcenter i Torslanda", varfor: "Kulturhus med bibliotek, biograf, sång- och dansundervisning, teater, kafé och utställningshall.", platsNamn: "Kulturhuset Vingen", adress: "Amhults Torg 7, 423 37 Torslanda", url: "https://www.goteborg.com/platser/kulturhuset-vingen", kvarter: "hisingen" }),
];
